...
=======
>>>>>>> c21dadcb23 (Removes the TerraGov Tech Vendor and Reorganizes Automated Weapons Vendors (#10613))
...
/obj/machinery/vending/uniform_supply
	...
	products = list(
		...
		"Service Dress" = list(
			/atom/movable/effect/essentials_set/white_dress = -1,
			...
			/atom/movable/effect/essentials_set/service_uniform = -1,
