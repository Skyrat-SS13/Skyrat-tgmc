...
/mob/living/carbon/human/update_inv_w_uniform()
	...
	overlays_standing[UNIFORM_LAYER] = w_uniform.make_worn_icon(slot_name = slot_w_uniform_str, default_icon = 'icons/mob/uniform_0.dmi', default_layer = UNIFORM_LAYER)
...
/mob/living/carbon/human/update_inv_wear_id()
	...
	if(w_uniform?.displays_id || istype(wear_id, /obj/item/card/id/dogtag))
		overlays_standing[ID_LAYER]	= wear_id.make_worn_icon(slot_name = slot_wear_id_str, default_icon = 'icons/mob/mob.dmi', default_layer = ID_LAYER)
...
/mob/living/carbon/human/update_inv_gloves()
	...
	if(gloves)
		...
		overlays_standing[GLOVES_LAYER]	= gloves.make_worn_icon(slot_name = slot_gloves_str, default_icon = 'icons/mob/hands.dmi', default_layer = GLOVES_LAYER)
...
/mob/living/carbon/human/update_inv_glasses()
	...
	if(glasses.goggles)
		overlays_standing[GOGGLES_LAYER] = glasses.make_worn_icon(slot_name = slot_glasses_str, default_icon = 'icons/mob/eyes.dmi', default_layer = GOGGLES_LAYER)
		apply_overlay(GOGGLES_LAYER)

	else
		overlays_standing[GLASSES_LAYER] = glasses.make_worn_icon(slot_name = slot_glasses_str, default_icon = 'icons/mob/eyes.dmi', default_layer = GLASSES_LAYER)
...
/mob/living/carbon/human/update_inv_ears()
	...
	overlays_standing[EARS_LAYER] = wear_ear.make_worn_icon(slot_name = slot_ear_str, default_icon = 'icons/mob/ears.dmi', default_layer = EARS_LAYER)
...
/mob/living/carbon/human/update_inv_shoes()
	...
	if(shoes)
		overlays_standing[SHOES_LAYER] = shoes.make_worn_icon(slot_name = slot_shoes_str, default_icon = 'icons/mob/feet.dmi', default_layer = SHOES_LAYER)
...
/mob/living/carbon/human/update_inv_s_store()
	...
	overlays_standing[SUIT_STORE_LAYER] = s_store.make_worn_icon(slot_name = slot_s_store_str, default_icon = 'icons/mob/suit_slot.dmi', default_layer = SUIT_STORE_LAYER)
...
/mob/living/carbon/human/update_inv_head()
	...
	overlays_standing[HEAD_LAYER] = head.make_worn_icon(slot_name = slot_head_str, default_icon = 'icons/mob/head_0.dmi', default_layer = HEAD_LAYER)
...
/mob/living/carbon/human/update_inv_belt()
	...
	overlays_standing[BELT_LAYER] = belt.make_worn_icon(slot_name = slot_belt_str, default_icon = 'icons/mob/belt.dmi', default_layer = BELT_LAYER)
...
/mob/living/carbon/human/update_inv_wear_suit()
	...
	overlays_standing[SUIT_LAYER] = wear_suit.make_worn_icon(slot_name = slot_wear_suit_str, default_icon = 'icons/mob/suit_0.dmi', default_layer = SUIT_LAYER)
...
/mob/living/carbon/human/update_inv_wear_mask()
	...
	overlays_standing[FACEMASK_LAYER] = wear_mask.make_worn_icon(slot_name = slot_wear_mask_str, default_icon = 'icons/mob/mask.dmi', default_layer = FACEMASK_LAYER)
...
/mob/living/carbon/human/update_inv_back()
	...
	overlays_standing[BACK_LAYER] = back.make_worn_icon(slot_name = slot_back_str, default_icon = 'icons/mob/back.dmi', default_layer = BACK_LAYER)
...
/mob/living/carbon/human/update_inv_handcuffed()
	...
	if(!handcuffed)
		return
	overlays_standing[HANDCUFF_LAYER] = handcuffed.make_worn_icon(slot_name = slot_handcuffed_str, default_icon = 'icons/mob/mob.dmi', default_layer = HANDCUFF_LAYER)
...
/mob/living/carbon/human/update_inv_r_hand()
	...
	overlays_standing[R_HAND_LAYER] = r_hand.make_worn_icon(inhands = TRUE, slot_name = slot_r_hand_str, default_icon = 'icons/mob/items_righthand_0.dmi', default_layer = R_HAND_LAYER)
...
/mob/living/carbon/human/update_inv_l_hand()
	...
	overlays_standing[L_HAND_LAYER] = l_hand.make_worn_icon(inhands = TRUE, slot_name = slot_l_hand_str, default_icon = 'icons/mob/items_lefthand_0.dmi', default_layer = L_HAND_LAYER)
