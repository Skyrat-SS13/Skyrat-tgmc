...
GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
		/atom/movable/effect/essentials_set/engi = list(CAT_ESS, "Essential Engineer Set", 0, "white"),
...
GLOBAL_LIST_INIT(medic_gear_listed_products, list(
		/atom/movable/effect/essentials_set/medic = list(CAT_ESS, "Essential Medic Set", 0, "white"),
...
GLOBAL_LIST_INIT(leader_gear_listed_products, list(
		/atom/movable/effect/essentials_set/leader = list(CAT_ESS, "Essential SL Set", 0, "white"),
...
GLOBAL_LIST_INIT(marine_clothes_listed_products, list(
		/atom/movable/effect/essentials_set/basic = list(CAT_STD, "Standard Kit", 0, "white"),
		/atom/movable/effect/essentials_set/basic_jaeger = list(CAT_STD, "Essential Jaeger Kit", 0, "white"),
		/atom/movable/effect/essentials_set/robot = list(CAT_STD, "Essential Combat Robot Kit", 0, "white"),
		/atom/movable/effect/modular_set/skirmisher = list(CAT_AMR, "Light Skirmisher Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/scout = list(CAT_AMR, "Light Scout Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/infantry = list(CAT_AMR, "Medium Infantry Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/eva = list(CAT_AMR, "Medium EVA Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/helljumper = list(CAT_AMR, "Medium Helljumper Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/assault = list(CAT_AMR, "Heavy Assault Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/eod = list(CAT_AMR, "Heavy EOD Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/helljumper = list(CAT_AMR, "Medium Helljumper Jaeger kit", 0, "orange"),
		/atom/movable/effect/essentials_set/xenonauten_light = list(CAT_AMR, "Xenonauten light armor kit", 0, "orange"),
		/atom/movable/effect/essentials_set/xenonauten_medium = list(CAT_AMR, "Xenonauten medium armor kit", 0, "orange"),
		/atom/movable/effect/essentials_set/xenonauten_heavy = list(CAT_AMR, "Xenonauten heavy armor kit", 0, "orange"),
...
GLOBAL_LIST_INIT(engineer_clothes_listed_products, list(
		/atom/movable/effect/essentials_set/basic_engineer = list(CAT_STD, "Standard kit", 0, "white"),
		/atom/movable/effect/essentials_set/basic_jaeger_engineer = list(CAT_STD, "Essential Jaeger Kit", 0, "white"),
		/atom/movable/effect/essentials_set/robot = list(CAT_STD, "Essential Combat Robot Kit", 0, "white"),
		...
		/atom/movable/effect/teleporter_linker = list(CAT_BAK, "Teleporters", 0, "black"),
...
GLOBAL_LIST_INIT(medic_clothes_listed_products, list(
		/atom/movable/effect/essentials_set/basic_medic = list(CAT_STD, "Standard kit", 0, "white"),
		/atom/movable/effect/essentials_set/basic_jaeger_medic = list(CAT_STD, "Essential Jaeger Kit", 0, "white"),
		/atom/movable/effect/essentials_set/robot = list(CAT_STD, "Essential Combat Robot Kit", 0, "white"),
		/atom/movable/effect/modular_set/skirmisher = list(CAT_AMR, "Light Skirmisher Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/scout = list(CAT_AMR, "Light Scout Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/infantry = list(CAT_AMR, "Medium Infantry Jaeger kit", 0, "orange"),
...
GLOBAL_LIST_INIT(smartgunner_clothes_listed_products, list(
		/atom/movable/effect/essentials_set/basic_smartgunner = list(CAT_STD, "Standard kit", 0, "white"),
		/atom/movable/effect/essentials_set/basic_jaeger_smartgunner = list(CAT_STD, "Essential Jaeger Kit", 0, "white"),
		/atom/movable/effect/essentials_set/robot = list(CAT_STD, "Essential Combat Robot Kit", 0, "white"),
		/atom/movable/effect/modular_set/skirmisher = list(CAT_AMR, "Light Skirmisher Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/scout = list(CAT_AMR, "Light Scout Jaeger kit", 0, "orange"),
		/atom/movable/effect/modular_set/infantry = list(CAT_AMR, "Medium Infantry Jaeger kit", 0, "orange"),
...
GLOBAL_LIST_INIT(leader_clothes_listed_products, list(
		/atom/movable/effect/essentials_set/basic_squadleader = list(CAT_STD, "Standard kit", 0, "white"),
		/atom/movable/effect/essentials_set/basic_jaeger_squadleader = list(CAT_STD, "Essential Jaeger Kit", 0, "white"),
		/atom/movable/effect/essentials_set/robot = list(CAT_STD, "Essential Combat Robot Kit", 0, "white"),
...
GLOBAL_LIST_INIT(synthetic_clothes_listed_products, list(
		/atom/movable/effect/essentials_set/synth = list(CAT_ESS, "Essential synthetic set", 0, "white"),
