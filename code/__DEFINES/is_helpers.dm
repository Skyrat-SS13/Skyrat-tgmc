...
#define iscathuman(H) (is_species(H, /datum/species/cathuman))
#define isanthromorph(H) (is_species(H, /datum/species/anthromorph))
#define isgenemodder(H) (is_species(H, /datum/species/genemodder))
#define islizardperson(H) (is_species(H, /datum/species/lizardperson))
#define isaquatic(H) (is_species(H, /datum/species/aquatic))
#define isinsectoid(H) (is_species(H, /datum/species/insectoid))
