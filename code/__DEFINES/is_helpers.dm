...
#define ismoth(H) (is_species(H, /datum/species/Cathuman))
#define ismoth(H) (is_species(H, /datum/species/Anthromorph))
#define ismoth(H) (is_species(H, /datum/species/Genemodder))
#define ismoth(H) (is_species(H, /datum/species/Lizardperson))
#define ismoth(H) (is_species(H, /datum/species/Aquatic))
#define ismoth(H) (is_species(H, /datum/species/Insectoid))
